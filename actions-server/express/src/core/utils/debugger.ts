...
export class Debugger implements Console {
  ...
  public constructor(
      console: Console, isEnabled: boolean = true, prefix: string = '') {
  ...
  public addPrefix(message: any): any {
    if (this.prefix && (typeof message === 'string' || !message)) {
      return `${new Date(Date.now()).toLocaleString()} ${this.prefix} ${
          message}`;
    }
    return message;
  }
  ...
  public get memory(): any {
    ...
    return this.doIfEnabled(
        () => console.hasOwnProperty('memory') && (console as any).memory);
  }

  public assert(value: any, message?: string, ...optionalParams: any[]): void;
  public assert(test?: boolean, message?: string, ...optionalParams: any[]):
      void;
  public assert(value?: any, message?: string, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => this.console.assert(value, message, ...optionalParams));
  }
  ...
  public dir(
      obj: any,
      options?: {showHidden?: boolean; depth?: number; colors?: boolean}): void;
  ...
  public error(message?: any, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => this.console.error(this.addPrefix(message), ...optionalParams));
  }

  public info(message?: any, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => this.console.info(this.addPrefix(message), ...optionalParams));
  }

  public log(message?: any, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => this.console.log(this.addPrefix(message), ...optionalParams));
  }
  ...
  public trace(message?: any, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => this.console.trace(this.addPrefix(message), ...optionalParams));
  }

  public warn(message?: any, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => this.console.warn(this.addPrefix(message), ...optionalParams));
  }
  ...
  public debug(message?: any, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => this.console.debug(this.addPrefix(message), ...optionalParams));
  }
  ...
  public exception(message?: string, ...optionalParams: any[]): void {
    return this.doIfEnabled(
        () => (this.console as any)
                  .exception(this.addPrefix(message), optionalParams));
  }
